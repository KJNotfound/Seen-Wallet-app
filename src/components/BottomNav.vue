<template>
  <div
    class="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-[68px] bg-white shadow-[0_-5px_20px_0px_rgba(0,0,0,0.05)] flex items-center justify-around px-4 z-50 pb-[env(safe-area-inset-bottom)]"
  >
    <!-- Home -->
    <div
      @click="$router.push('/')"
